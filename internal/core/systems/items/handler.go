...
type ItemHandler interface {
    ...
    OnEquip(entity entity.Entity, world *ecs.World, eventBus eventsys.EventBus)
    ...
    ProcessEvent(event interface{}, entity entity.Entity, world *ecs.World, eventBus eventsys.EventBus)
}