...
func (s *StatCalculationSystem) ApplyStaticBonusStats() {
	...
	// health.SetBaseMaxHP(calculatedMaxHp)
	...
	// health.SetBaseArmor(calculatedArmor)
	...
	// attack.SetBaseCritChance(calculatedCritChance)
	...
	// attack.SetBaseCritMultiplier(calculatedCritMultiplier)
	...
	// attack.SetBaseDamageAmp(calculatedDamageAmp)

	// Range: Base + Bonus (Assuming simple addition)
	attack.SetFinalRange(attack.GetBaseRange() + attack.GetBonusRange())
	// attack.SetBaseRange(attack.GetBaseRange() + attack.GetBonusRange())
	// attack.ResetBonuses()
	...
	// mana.SetBaseInitialMana(calculatedInitialMana)
	mana.SetCurrentMana(calculatedInitialMana)
	// mana.ResetBonuses()
	...
	spell.SetBaseAP(calculatedSpellDamage)
	// spell.ResetBonuses()
