            ...
            <TooltipProvider key={i} delayDuration={100}>
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="flex items-center gap-2 relative cursor-pointer  hover:bg-secondary p-1 rounded-md transition-colors">
                ...
                >
                  <div className="font-bold text-lg mb-2">{champion.name}</div>
